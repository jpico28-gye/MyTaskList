...
> = {
  ...
  amber: {
    name: 'Amber',
    label: 'Amber / Idea',
    chip: 'bg-amber-500/15 text-amber-800 dark:text-amber-200 border-amber-300 dark:border-amber-700',
    card: 'border-amber-300/80 dark:border-amber-800/80 bg-amber-50 dark:bg-amber-950/90 border-l-4 border-l-amber-500 shadow-xs',
    dot: 'bg-amber-500',
    bar: 'bg-amber-500',
  },
  emerald: {
    ...
    chip: 'bg-emerald-500/15 text-emerald-800 dark:text-emerald-200 border-emerald-300 dark:border-emerald-700',
    card: 'border-emerald-300/80 dark:border-emerald-800/80 bg-emerald-50 dark:bg-emerald-950/90 border-l-4 border-l-emerald-500 shadow-xs',
    dot: 'bg-emerald-500',
    bar: 'bg-emerald-500',
  },
  violet: {
    ...
    chip: 'bg-violet-500/15 text-violet-800 dark:text-violet-200 border-violet-300 dark:border-violet-700',
    card: 'border-violet-300/80 dark:border-violet-800/80 bg-violet-50 dark:bg-violet-950/90 border-l-4 border-l-violet-500 shadow-xs',
    dot: 'bg-violet-500',
    bar: 'bg-violet-500',
  },
  rose: {
    ...
    chip: 'bg-rose-500/15 text-rose-800 dark:text-rose-200 border-rose-300 dark:border-rose-700',
    card: 'border-rose-300/80 dark:border-rose-800/80 bg-rose-50 dark:bg-rose-950/90 border-l-4 border-l-rose-500 shadow-xs',
    dot: 'bg-rose-500',
    bar: 'bg-rose-500',
  },
  blue: {
    ...
    chip: 'bg-blue-500/15 text-blue-800 dark:text-blue-200 border-blue-300 dark:border-blue-700',
    card: 'border-blue-300/80 dark:border-blue-800/80 bg-blue-50 dark:bg-blue-950/90 border-l-4 border-l-blue-500 shadow-xs',
    dot: 'bg-blue-500',
    bar: 'bg-blue-500',
  },
}
